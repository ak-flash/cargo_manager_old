...
$query = "INSERT INTO `orders` (`manager`,`tr_manager`,`client`,`cl_pref`,`cl_nds`,`cl_event`,`data`,`in_adress`,`out_adress`,`cl_cash`,`transp`,`tr_pref`,`tr_nds`,`tr_event`,`tr_cash`,`cl_minus`,`cl_plus`,`tr_minus`,`tr_plus`,`cl_tfpay`,`tr_tfpay`,`gruz`,`gr_m`,`gr_v`,`gr_number`,`gr_load`,`tr_auto`,`cl_cont`,`tr_cont`,`tr_receive`,`print_cl`,`print_tr`,`date_in1`,`time_in11`,`time_in12`,`date_in2`,`time_in21`,`time_in22`,`date_out1`,`date_out2`,`time_out1`,`time_out2`,`id`,`car_notify`,`notify`,`km`,`date_plan`,`krugoreis`,`days_tfpay`,`international_number`,`cl_kop`,`tr_days`,`cl_rashod_na_cl`,`cl_rashod_sb`,`cl_komissia`,`tr_komissia`,`cl_currency`,`tr_currency`) VALUES ('$manager','$tr_manager','$client','$cl_pref','$cl_nds','$cl_event','$data','$in_adr','$out_adr','$cl_cash','$transporter','$tr_pref','$tr_nds','$tr_event','$tr_cash','$cl_minus','$cl_plus','$tr_minus','$tr_plus','$cl_tfpay','$tr_tfpay','$gruz_name','$gruz_m','$gruz_v','$gruz_num','$gruz_load','$car','$cl_cont','$tr_cont','$tr_receive','$print_cl','$print_tr','$in_data1','$in_time11','$in_time12','$in_data2','$in_time21','$in_time22','$out_data1','$out_data2','$out_time1','$out_time2','$order_id','$car_notify','$notify','$ati_km','$date_plan','$krugoreis','$days_tfpay','$international_number','$cl_kop','$tr_days','$cl_rashod_na_cl','$cl_rashod_sb','$cl_komissia','$tr_komissia','$cl_currency','$tr_currency')";
