...
if($_GET['mode']=="tn"){
	...
	$query = "SELECT *, o.id, o.data, o.in_adress, o.out_adress, t.pref as tr_pref, t.name as tr_name, t.tr_adr_f as tr_adress, t.tr_chief as tr_chief, c.pref as cl_pref, c.name as cl_name, c.cl_adr_f as cl_adress, ta.car_driver_name, ta.car_driver_inn, ta.car_driver_phone, ta.car_name, ta.car_number, ta.car_owner_type  FROM orders AS o LEFT JOIN clients AS c ON o.client=c.id LEFT JOIN transporters AS t ON o.transp=t.id LEFT JOIN tr_autopark ta ON o.tr_auto=ta.id WHERE o.id='".(int)$id."'";
...
// Page 2
	...
	$sheet2->setCellValueByColumnAndRow(58, 12, $row['car_number']);
