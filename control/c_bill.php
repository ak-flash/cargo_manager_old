...
echo '<tr><td align=center bgcolor=#F2F5F7><font size=4><b>' . ($f + 1) . '</b></font></td><td align=center><b>' . $bill_info[2] . '</b></td><td bgcolor=#F9F9F9 align=center>' . $bill_info[3] . '</td><td align=center>' . $bill_info[4] . '</td><td  align=center>' . $bill_info[5] . '</td><td  align=center>' . $cash_all . ' </td><td align=center bgcolor=#F2F5F7><a href="#" id="edit_bill" onclick=\'$("#fa_add_bill").load("theme/forms/add_bill.php?mode=edit&c_bill=' . $bill_info[0] . '");$("#fa_add_bill").dialog({ title: "Редактировать счет №' . $bill_info[2] . '" },{width: 520,height: 390,modal: true,resizable: false});\' style="text-decoration:none;"><img src="data/img/document-edit.png" style="width:35px;"></a>&nbsp;&nbsp;&nbsp;&nbsp;
' . $del_button . '</td></tr>';
