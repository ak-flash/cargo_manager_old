...
<a class="button" id="btnMonth" href="#" style="width:120px;">За месяц</a>
...
За период: с <input type="text" id="date_start" name="date_start" style="width:80px;" value="" class="input"> по <input type="text" id="date_end" name="date_end" style="width:80px;" class="input">&nbsp;<a class="button" id="btnData" href="#" style="width:100px;">Показать</a>
...
&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="btnSetVzaim" onclick=\'$.post("control/admin.php?vzaimozachet="+$("#table").jqGrid("getGridParam","selarrrow"), function(data) { $("#result").html(data);jQuery("#table").trigger("reloadGrid");$("#result").dialog({ title: "Готово" },{ width: 410 },{ modal: true },{ resizable: false },{ buttons: { "Ok": function() { $(this).dialog("close"); } } });});\' value="Отм. «Взаимозачет»" style="font-size: 12px;width: 160px;">&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="btnShowDel" onclick=\'$("#table").setGridParam({url:"control/orders.php?mode=orders&showdel=true"});jQuery("#table").trigger("reloadGrid");\' value="Удалённые заявки" style="font-size: 12px;width: 160px;height:35px;"></fieldset>';
}
?>
